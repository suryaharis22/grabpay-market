...
const AddPackage = () => {
    ...
    const handleChange = (index, e) => {
        ...
        // Validasi untuk msisdn
        // Validasi untuk msisdn
        if (name === "msisdn") {
            const isValidMsisdn = /^[0-9]{10,12}$/.test(value) && value.startsWith("08");

            if (!isValidMsisdn) {
                errorMassage.msisdn = "MSISDN harus dimulai dengan '08' dan terdiri dari 10-12 digit";
            } else {
                errorMassage.msisdn = "";  // Clear error message if valid
            }
        }
