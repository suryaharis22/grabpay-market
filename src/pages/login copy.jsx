...
const Login = () => {
    ...
    // Mengecek jika access_token hilang dan menghapus localStorage
    useEffect(() => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            Cookies.set('access_token', access_token, { expires: 1 }); // Token disimpan selama 1 hari
            Cookies.set('access_token', access_token, { expires: 1 / 24 });

            // Dapatkan data profile
            ...
            // Simpan data profile di localStorage
            ...
            console.error(error); // Menambahkan log error untuk debug
        } finally {
            setLoading(false);
        }
    };
                ...
                <form onSubmit={handleLogin}>
                    ...
                    >
                        {loading ? (
                            <svg
                                aria-hidden="true"
                                className="w-6 h-6 text-gray-200 animate-spin dark:text-primary fill-secondary"
                                viewBox="0 0 100 101"
                                fill="none"
